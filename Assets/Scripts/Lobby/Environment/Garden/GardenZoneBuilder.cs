...
namespace RangerCity.Lobby
{
    ...
    public static class GardenZoneBuilder
    {
        ...
        private static void BuildFlowerMeadow(Transform parent)
        {
            ...
            // Area sign
            ZoneFactory.CreateAreaSign(area.transform, new Vector3(-1.5f, 0.6f, -1.5f), "Hoa Viên");
        ...
        private static void BuildZenGarden(Transform parent)
        {
            ...
            // Area sign
            ZoneFactory.CreateAreaSign(area.transform, new Vector3(0f, 0.6f, -1.8f), "Vườn Thiền");
        ...
        private static void BuildVegetablePlots(Transform parent)
        {
            ...
            // Area sign
            ZoneFactory.CreateAreaSign(area.transform, new Vector3(0f, 0.6f, -1.6f), "Vườn Rau Sinh Thái");
        ...
        private static void BuildFountainGarden(Transform parent)
        {
            ...
            // Area sign
            ZoneFactory.CreateAreaSign(area.transform, new Vector3(0f, 0.6f, -2.6f), "Vườn Đài Phun");
