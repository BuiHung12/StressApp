...
def main():
    ...
    stdin, stdout, stderr = client.exec_command(
        'ls -la /home/hung/Applications/project2/Assets/TextMesh\\ Pro/ 2>/dev/null || echo "NOT_FOUND"'
    )
    ...
    stdin, stdout, stderr = client.exec_command(
        'ls -la /home/hung/Applications/project2/Assets/Scripts/Lobby/*.cs | wc -l'
    )
    ...
    stdin, stdout, stderr = client.exec_command(
        'grep -rn "CreateTrees()" /home/hung/Applications/project2/Assets/Scripts/Lobby/ 2>/dev/null || echo "No old refs"'
    )
    ...
    stdin, stdout, stderr = client.exec_command(
        'grep -n "_moveSpeed\|_wanderPause\|_wanderRadius" /home/hung/Applications/project2/Assets/Scripts/Lobby/NPCController.cs 2>/dev/null'
    )
